...
<head>
    ...
    <script>
        ...
        fbq('init', '648543032279747');
        fbq('track', 'PageView');
    </script>
    <noscript><img height="1" width="1" style="display:none" src="https://www.facebook.com/tr?id=648543032279747&ev=PageView&noscript=1"/></noscript>
    <!-- End Meta Pixel Code-->
</head>
<body>
	<!-- Loder Start -->
