...
class GalleryController extends Controller
{
    ...
    {
        $posts=Gallery::all();
        return view('pages.backend..gallery.index')->with('posts',$posts);
    }
    ...
    {
        return view('pages.backend..gallery.show')->with('posts', $gallery);
    }
    ...
    public function edit($id)
    {
       $posts=Gallery::findOrFail($id);
        return view('pages.backend..gallery.edit')->with('posts',$posts);
    }
    ...
    {
        $posts=Gallery::all();
        return view('pages.backend..gallery.bv-gallery')->with('posts',$posts);
    }
    public function bvGalleryImage($id)
    {
        $posts=Gallery::findOrFail($id);
        return view('pages.backend..gallery.bv-gallery-image')->with('posts',$posts);
    }
